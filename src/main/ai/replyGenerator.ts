...
function buildVipReplyContents(params: {
  ...
  return `以下の記事に関するスレッドで、他の住民やユーザーと雑談・議論を交わしています。
...
${latestReplyRule}
4. 元記事の主題と事実関係の正確性を保ってください。記事や質問に合う観点と語彙を使い、無関係な分野の用語、比喩、専門家視点を持ち込まないでください。常連住民の属性も記事の主題と衝突する場合は前面に出さないでください。
