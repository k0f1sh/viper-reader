...
export type ViperReaderApi = {
  ...
  listFailedGenerationQueue: (page: number) => Promise<ThreadListPage>;
...
const api: ViperReaderApi = {
  ...
  listFailedGenerationQueue: (page) => ipcRenderer.invoke("threads:list-failed-generation-queue", page),
